...
export default function GalleryPlay({ inPlay }: Readonly<{ inPlay: boolean }>) {
  let firstChildrenVariants: Variants = {
    initial: {
      transform: "matrix(0.01, 0, 0, 0.01, 0, 0)",
      width: "56px",
      height: "56px",
      backgroundColor: "rgba(90, 91, 94, 0.65)",
      borderRadius: "30px",
    },
    animate: {
      opacity: inPlay ? 1 : 0,
  ...
  let playButtonVariants: Variants = {
    initial: {
      transform: "matrix(0.01, 0, 0, 0.01, 0, 0)",
      width: "156px",
      height: "56px",
  ...
  let listSwiperVariants: Variants = {
    initial: {
      transform: "matrix(0.01, 0, 0, 0.01, 0, 0)",
      width: "56px",
      height: "56px",
  ...
  return (
    <motion.div className="sticky top-0 bottom-0">
      <motion.div
        initial="initial"
        animate="animate"
        className="absolute"
        variants={firstChildrenVariants}
